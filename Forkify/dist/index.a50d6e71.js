...
})({"gsJ4C":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "55338821a50d6e71";
"use strict";
...
},{}],"cvPzG":[function(require,module,exports) {
...
const showRecipe = async function() {
    try {
        //get dinamically the recipe-id
        const id = window.location.hash.slice(1);
        console.log(id);
        if (!id) return;
        //288 Loading Recipe from API
...
${recipe.ingrediets.map((ing)=>{
    ...
    <li class="recipe__ingredient">
        ...
        recipeContainer.innerHTML = ""; //set html to "",=> old markup entfernen
...
},{"core-js/modules/es.regexp.flags.js":"gSXXb","core-js/modules/web.immediate.js":"49tUX","url:../img/icons.svg":"hTnvb","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gSXXb":[function(require,module,exports) {
...
},{"../internals/export":"dIGt4","../internals/global":"i8HOC","../internals/task":"7jDg7"}],"hTnvb":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("7jwwa") + "icons.dfd7a6db.svg" + "?" + Date.now();
...
},{}]},["gsJ4C","cvPzG"], "cvPzG", "parcelRequire3a11")

//# sourceMappingURL=index.a50d6e71.js.map
